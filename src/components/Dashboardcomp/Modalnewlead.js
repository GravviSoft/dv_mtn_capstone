...
function ModalNewLead(props){
    return (
                        <Dialog header="Lead Form" visible={props.visibleNewLead} footer={props.productDialogFooter}  style={{ width: '35vw' }} onHide={() => props.setVisibleNewLead()}>
                            ...
                            <div className="p-inputgroup mb-4">
                                ...
                                <Dropdown value={props.leadStatus} onChange={(e) => props.setLeadStatus(e.value)} options={props.statuses}
    ...
    //     return (
    //                     <Dialog header="Create New Lead" visible={props.visibleNewLead} footer={props.productDialogFooter}  style={{ width: '35vw' }} onHide={() => props.setVisibleNewLead()}>
    //                         {/* ERROR MSG */}
    //                         {props.submitNewLead &&  props.companyError ? <div className="p-inputgroup mb-1"><Message severity="error" text="Company is required"  className="border-primary w-full justify-content-start"  /></div> : null}
    //                         <div className="p-inputgroup mb-4"> 
    //                             <span className="p-inputgroup-addon">
